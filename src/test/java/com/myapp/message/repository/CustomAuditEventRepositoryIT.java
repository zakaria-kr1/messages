...
import com.myapp.message.config.audit.AuditEventConverter;
import com.myapp.message.domain.PersistentAuditEvent;
...
import static com.myapp.message.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
