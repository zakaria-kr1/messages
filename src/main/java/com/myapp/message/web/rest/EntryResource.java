...
/**
 * REST controller for managing {@link com.myapp.message.domain.Entry}.
 */
@RestController
@RequestMapping("/api")
public class EntryResource {
    ...
    public ResponseEntity<Entry> updateEntry(@Valid @RequestBody Entry entry) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, entry.getId()))
            .body(result);
    }
