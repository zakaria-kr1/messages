...
/**
 * REST controller for managing {@link com.myapp.message.domain.Blog}.
 */
@RestController
@RequestMapping("/api")
public class BlogResource {
    ...
    public ResponseEntity<Blog> updateBlog(@Valid @RequestBody Blog blog) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, blog.getId()))
            .body(result);
    }
